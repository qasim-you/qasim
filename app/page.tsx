  ...
  return (
    <>
      <Head>
        ...
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Muhammad Qasim | Full Stack Developer" />
        <meta property="og:description" content="Explore projects by Qasim - React, AI, and full stack development." />
        <meta property="og:image" content="https://qasimcode.vercel.app//preview.png" />
        <meta property="og:url" content="https://qasimcode.vercel.app/" />
      ...
      <main className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-10 container mx-auto p-3 sm:p-4 pt-20 sm:pt-24 pb-6 sm:pb-8">
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                      <div className="flex items-center">
                        ...
                        <h3 className="text-lg font-medium"> Real Time Projects</h3>
                      </div>
          ...
          >
            <p>© {new Date().getFullYear()} Muhammad Qasim. All rights reserved.</p>
          </AnimatedSection>
        </div>
